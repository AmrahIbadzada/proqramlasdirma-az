...
<details>
<summary><b>Universitetsiz proqramçı olmaq olarmı?</b></summary>

Bəli, olur. Lakin bir neçə şeyi bilmək lazımdır:

**Universitetin verdiyi şeylər:**
- Alqoritmlər, məlumat strukturları, kompüter arxitekturası kimi dərin əsas bilik
- Network (tanışlıqlar, internship imkanları)
- Böyük texnologiya şirkətlərinin əksəriyyətinin ilk seçimidir

**Universitetssiz proqramçı olmaq üçün:**
- Güclü GitHub portfolio (real layihələr, töhfələr)
- Açıq mənbə layihələrə qatkı
- Bootcamp sertifikatları (məsələn: freeCodeCamp, The Odin Project)
- Müsahibə hazırlığı (LeetCode, HackerRank)

**Nəticə:** Böyük şirkətlər üçün çətin olsa da, startaplar, orta şirkətlər və freelance dünyasında universitetin həmişə tələb olunmur.
...
1. **Konsepsiyanı öyrən** → Video/kurs ilə (passiv)
2. **Tətbiq et** → Özün yaz, sıl, yenidən yaz (aktiv)
3. **Layihə qur** → Öyrəndiklərini real bir şeydə istifadə et
4. **Oxu** → Sənədlər (documentation) oxumaq vərdişini qazanmaq şərtdir

**Tövsiyə:** İlk öyrəndikdə 30% izlə, 70% özün yaz. Passiv oxumaq/izləmək öyrənmənin yalnız başlanğıcıdır.

</details>

<details>
<summary><b>Proqramlaşdırmağı öyrənmək nə qədər çəkir?</b></summary>

| Hədəf | Müddət (gündə 2-3 saat) |
|-------|------------------------|
| İlk tətbiqi qur | 1-3 ay |
| İş üçün hazır (junior) | 6-12 ay |
| Mid-level developer | 2-3 il |
| Senior developer | 5+ il |

**Xəbərdarlıq:** "6 ayda proqramçı ol" reklamlarına inanma. 6 ayda junior olmaq **mümkündür**, amma bu çox ardıcıl çalışma tələb edir.
...
**Ödəmədən əvvəl:** freeCodeCamp, The Odin Project, CS50 ilə başla. Bu qaynaqların çoxu pullu kurslardan daha yaxşıdır.

</details>

<details>
<summary><b>Bootcamp-ə getməyə dəyərmi?</b></summary>

Bootcamp-lər 3-6 aylıq intensiv proqramlardır.

**Müsbət tərəfləri:**
- Strukturlu öyrənmə mühiti
- Mentor dəstəyi
- Networking imkanları
- Career placement xidmətləri

**Mənfi tərəfləri:**
- Çox baha ($5,000 - $20,000+)
- Keyfiyyət çox dəyişir
- "İş garantisi" iddialarına ehtiyatla yanaş

**Alternativ:** The Odin Project + freeCodeCamp + güclü portfolio = bootcamp-ə bərabər nəticə, tamamilə pulsuzdur.
...
**Başlanğıc üçün layihə ideyaları:**

*Python:*
- Hava proqnozu tətbiqi (API istifadəsi)
- Avtomatik fayl təşkiledici (OS automation)
- Sadə veb scraper
- To-do list CLI tətbiqi

*JavaScript/Veb:*
- Şəxsi portfolio sayt
- Quiz tətbiqi
- Hava proqnozu saytı (API ilə)
- Alış-veriş siyahısı (localStorage)

*Full-Stack:*
- Blog platforması (CRUD əməliyyatları)
- URL qısaldıcı
- İş elanları saytı
- Real-time çat tətbiqi

**Əsas qayda:** 10 natamam layihə deyil, **3 tam bitmiş layihə** daha çox dəyər daşıyır.
...
2024-2025-ci illərdə bazar çətin olmuşdur:
...
2. LeetCode-da ardıcıl məşq et
3. Şirkətlərə birbaşa LinkedIn mesajı yaz (spam deyil, personallaşdırılmış)
4. Hər başvuruya xüsusi cover letter yaz
5. Frilanser işlər (Fiverr, Upwork) ilə təcrübə topla

</details>

<details>
<summary><b>CV-yə nə yazmalıyam, nə yazmamalıyam?</b></summary>
...
<details>
<summary><b>Hansı AI alətlərini öyrənməliyəm?</b></summary>

| Alət | İstifadə |
|------|---------|
| [GitHub Copilot](https://github.com/features/copilot) | Kod yazarkən avtomatik tamamlama |
| [Claude](https://claude.ai) | Kod izahatı, debug, arxitektura müzakirəsi |
| [ChatGPT](https://chatgpt.com) | Ümumi proqramlaşdırma sualları |
| [Cursor](https://cursor.sh) | AI ilə gömülü kod redaktoru |
...
<details>
<summary><b>Git öyrənməli miyəm? Bunu nə üçün istifadə edirlər?</b></summary>

**Git mütləq öyrənilməlidir.** Versiyalama sistemidir.

**Git nə işə yarayır:**
- Kodun tarixini qoruyur (hər dəyişikliyi yadda saxlayır)
- Komanda ilə birlikdə eyni layihə üzərində işləməyə imkan verir
- Səhv dəyişikliyi geri qaytarmağa imkan verir
...
git clone URL     # Mövcud repo-nu kopyala
git add .         # Bütün dəyişiklikləri hazırla
git commit -m ""  # Commit yarat
git push          # GitHub-a yüklə
git pull          # Son dəyişiklikləri al
git branch        # Branch-lara bax
git checkout -b   # Yeni branch yarat
```

</details>

<details>
<summary><b>Linux öyrənməliyəm?</b></summary>
...
|-------|-----------|--------|
| [Automate the Boring Stuff](https://automatetheboringstuff.com) | Python | Pulsuz online |
| [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) | JavaScript | Pulsuz GitHub-da |
| [Clean Code](https://www.amazon.com/Clean-Code/dp/0132350882) | Ümumi | Ödənişli |
| [The Pragmatic Programmer](https://pragprog.com/titles/tpp20/) | Ümumi | Ödənişli |
| [Structure and Interpretation of Computer Programs](https://mitpress.mit.edu/sites/default/files/sicp/index.html) | CS Əsasları | Pulsuz online |
| [Eloquent JavaScript](https://eloquentjavascript.net) | JavaScript | Pulsuz online |
| [Python Crash Course](https://nostarch.com/python-crash-course-3rd-edition) | Python | Ödənişli |
